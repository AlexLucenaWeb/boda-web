...
export default function Foto() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const end = 0.60;   // baja esto si quieres que termine antes (0.75–0.95)
    ...
    >
      <div className="relative h-[500px] min-h-[600px] w-full overflow-hidden flex justify-center">
        <div
          ...
          style={{
            backgroundImage: "url('https://ze8vcqyvmyipglfi.public.blob.vercel-storage.com/ninajano.webp')",
